...
const writerRestaurants = fs.createWriteStream(path.resolve(__dirname, './csv/restaurants.csv'));
const writerReviews = fs.createWriteStream(path.resolve(__dirname, './csv/reviews.csv'));
const writerCategories = fs.createWriteStream(path.resolve(__dirname, './csv/categories.csv'));
const writerJoin = fs.createWriteStream(path.resolve(__dirname, './csv/join.csv'));
